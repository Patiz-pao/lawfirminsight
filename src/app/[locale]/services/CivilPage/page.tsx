...
import { civilImage } from "../../../../../public/images";
import { useTranslations } from "next-intl";
import { Shield, AlertTriangle, Gavel, Scale, Clock } from "lucide-react";
import { useActiveTab } from "@/hooks/useActiveTab";

const civil = () => {
  const t = useTranslations("CivilPage");

  const { activeTab, changeTab } = useActiveTab("overview");

  const civilTypes = [
    {
      title: t("civilTypes.title"),
      description: t("civilTypes.description"),
      punishment: t("civilTypes.punishment"),
      examples: t("civilTypes.examples").split(", "),
    },
    {
      title: t("civilTypes_2.title"),
      description: t("civilTypes_2.description"),
      punishment: t("civilTypes_2.punishment"),
      examples: t("civilTypes_2.examples").split(", "),
    },
    {
      title: t("civilTypes_3.title"),
      description: t("civilTypes_3.description"),
      punishment: t("civilTypes_3.punishment"),
      examples: t("civilTypes_3.examples").split(", "),
    },
  ];

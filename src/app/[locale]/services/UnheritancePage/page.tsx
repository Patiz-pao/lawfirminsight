...
import { unheritance } from "../../../../../public/images";
import { useTranslations } from "next-intl";
import { Shield, AlertTriangle, Gavel, Scale, Clock } from "lucide-react";
import { useActiveTab } from "@/hooks/useActiveTab";

const unheritancePage = () => {
  const t = useTranslations("InheritancePage");

  const { activeTab, changeTab } = useActiveTab("overview");

  const inheritanceTypes = [
    {
      title: t("inheritanceTypes.title"),
      description: t("inheritanceTypes.description"),
      punishment: t("inheritanceTypes.punishment"),
      examples: t("inheritanceTypes.examples").split(", "),
    },
    {
      title: t("inheritanceTypes_2.title"),
      description: t("inheritanceTypes_2.description"),
      punishment: t("inheritanceTypes_2.punishment"),
      examples: t("inheritanceTypes_2.examples").split(", "),
    },
    {
      title: t("inheritanceTypes_3.title"),
      description: t("inheritanceTypes_3.description"),
      punishment: t("inheritanceTypes_3.punishment"),
      examples: t("inheritanceTypes_3.examples").split(", "),
    },
  ];
        ...
        <div className="py-8">
          ...
          {activeTab === "types" && (
            <div className="space-y-6">
              {inheritanceTypes.map((type, index) => (
...
export default unheritancePage;
...
import { taxImage } from "../../../../../public/images";
...
const taxPage = () => {
  ...
  const taxTypes = [
    {
      title: t("taxTypes.title"),
      description: t("taxTypes.description"),
      punishment: t("taxTypes.punishment"),
      examples: t("taxTypes.examples").split(", "),
    },
    {
      title: t("taxTypes_2.title"),
      description: t("taxTypes_2.description"),
      punishment: t("taxTypes_2.punishment"),
      examples: t("taxTypes_2.examples").split(", "),
    },
    {
      title: t("taxTypes_3.title"),
      description: t("taxTypes_3.description"),
      punishment: t("taxTypes_3.punishment"),
      examples: t("taxTypes_3.examples").split(", "),
    },
  ];

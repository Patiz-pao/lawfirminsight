...
import { specialinvestigative } from "../../../../../public/images";
import { useTranslations } from "next-intl";
import { Shield, AlertTriangle, Gavel, Scale, Clock } from "lucide-react";
import { useActiveTab } from "@/hooks/useActiveTab";

const SpecialInvestigativePage = () => {
  const t = useTranslations("SpecialInvestigationPage");

  const { activeTab, changeTab } = useActiveTab("overview");

  const specialInvestigationType = [
    {
      title: t("specialInvestigationTypes.title"),
      description: t("specialInvestigationTypes.description"),
      punishment: t("specialInvestigationTypes.punishment"),
      examples: t("specialInvestigationTypes.examples").split(", "),
    },
    {
      title: t("specialInvestigationTypes_2.title"),
      description: t("specialInvestigationTypes_2.description"),
      punishment: t("specialInvestigationTypes_2.punishment"),
      examples: t("specialInvestigationTypes_2.examples").split(", "),
    },
    {
      title: t("specialInvestigationTypes_3.title"),
      description: t("specialInvestigationTypes_3.description"),
      punishment: t("specialInvestigationTypes_3.punishment"),
      examples: t("specialInvestigationTypes_3.examples").split(", "),
    },
  ];
        ...
        <div className="py-8">
          ...
          {activeTab === "types" && (
            <div className="space-y-6">
              {specialInvestigationType.map((type, index) => (
...
export default SpecialInvestigativePage;
...
const Criminal = () => {
  ...
  const criminalTypes = [
    {
      title: t("criminalTypes.title"),
      description: t("criminalTypes.description"),
      punishment: t("criminalTypes.punishment"),
      examples: t("criminalTypes.examples").split(", "),
    },
    {
      title: t("criminalTypes_2.title"),
      description: t("criminalTypes_2.description"),
      punishment: t("criminalTypes_2.punishment"),
      examples: t("criminalTypes_2.examples").split(", "),
    },
    {
      title: t("criminalTypes_3.title"),
      description: t("criminalTypes_3.description"),
      punishment: t("criminalTypes_3.punishment"),
      examples: t("criminalTypes_3.examples").split(", "),
    },
  ];
